...
| 8 | Usability / Visual | Cart Icon Overlaps Divider Lines - Visual User [Evidence](screenshots/Cart%20Overlap%20-%20Visual%20User.png) | With "visual_user", the shopping cart icon overlaps divider lines on Home and Checkout pages, breaking visual consistency. | 1. Login as visual_user<br>2. View Home page<br>3. Navigate to Checkout pages | Low/Medium | Fix CSS positioning of cart icon to align properly. | 
